...
- Interface dark theme, 280px, pensée pour une utilisation prolongée

---

## Ce que ce projet m'a appris

Apps Script est un environnement avec ses propres contraintes (latence des appels, limites de l'API Sheets, pas de state persistant côté client). Résoudre ces contraintes m'a poussée à appliquer des patterns front-end habituellement réservés à des apps plus complexes — notamment l'optimistic UI — dans un contexte inhabituel.

C'est aussi un projet où j'ai navigué seule entre la conception, le développement, les bugs et les itérations UX, ce qui correspond exactement à ma façon de travailler.
